...
public class Download extends AbstractWebsite {
  ...
  public CharSequence contents() {
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t  ");
    _builder.append("href=\"http://jee6-generator.itemis.de/updates/juno/\"");
    _builder.newLine();
    _builder.append("\t\t\t\t\t    \t");
    _builder.append("class=\"has-popover btn btn-primary btn-large\"");
    _builder.newLine();
    _builder.append("\t\t\t\t\t    \t");
    _builder.append("style=\"width: 70%;\">Juno</a></td>");
    _builder.newLine();
    _builder.append("\t\t\t\t\t    ");
    _builder.append("</tr>");
    _builder.newLine();
    ...
    _builder_2.append("<p>The JEE6 Generator is freely available under the <a href=\"http://www.eclipse.org/legal/epl-v10.html\">Eclipse Public License</a>.</p>");
    _builder_2.newLine();
    _builder_2.append("<p>");
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.append("The license allows to use the JEE6 Generator for development and even for developing and selling commercial products based on the JEE6 Generator.");
    _builder_2.newLine();
    _builder_2.append("</p>");
    _builder_2.newLine();
    CharSequence _faqEntry_1 = this.faqEntry("What is the license of the JEE6 Generator?", _builder_2);
